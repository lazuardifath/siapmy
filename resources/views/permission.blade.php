...
@section('content')
    ...
    <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('roles[]', $roles, null,[ 'class'=>'form-control select2 form-control-sm', 'multiple' => 'multiple']) !!}
                                    </div>
                                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card p-3">
                    <div class="card-body">
                        <table id="permission_table" class="table display nowrap">
                            <thead>
                                <tr>
                                    <th>{{ __('Permission')}}</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#permission_table .delete-link', function(event) {
